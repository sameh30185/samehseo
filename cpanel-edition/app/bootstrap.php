...
require_once __DIR__ . '/Security/UrlGuard.php';
require_once __DIR__ . '/Security/TempElevation.php';
...
require_once __DIR__ . '/AI/SchemaValidator.php';
require_once __DIR__ . '/AI/JobQueue.php';
require_once __DIR__ . '/AI/WorkerService.php';
...
require_once __DIR__ . '/Brain/ProjectBrain.php';
require_once __DIR__ . '/Integrations/CsvImport.php';
require_once __DIR__ . '/Integrations/SitemapFetch.php';
require_once __DIR__ . '/Integrations/ResearchFetch.php';
require_once __DIR__ . '/Http/WorkerApi.php';
